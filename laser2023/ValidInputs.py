# This code was originally made by Philippe Miquelon during the Fall 2021 semester. The code was made for C# in the first place and was more or less translated into Python. This code will force the user to enter a correct input in order for the code to continue working.
